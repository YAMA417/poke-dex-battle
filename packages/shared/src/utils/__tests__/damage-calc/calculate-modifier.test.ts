...
describe('calculateModifier', () => {
  ...
  it('should return base damage without modifiers', () => {
    const baseDamage = 46;
    const result = calculateModifier(baseDamage, attacker, defender, move, context);
  ...
  it('should apply double battle spread modifier (0.75x)', () => {
    ...
    const result = calculateModifier(baseDamage, attacker, defender, move, spreadContext);
  ...
  it('should apply weather modifier (sun boost Fire type)', () => {
    ...
    const result = calculateModifier(baseDamage, attacker, defender, fireMove, sunContext);
  ...
  it('should apply critical hit modifier (1.5x)', () => {
    ...
    const result = calculateModifier(baseDamage, attacker, defender, critMove, context);
  ...
  it('should not apply STAB for different type', () => {
    ...
    const result = calculateModifier(baseDamage, attacker, defender, fireMove, context);
    // No STAB: 1.0x
  ...
  it('should apply type effectiveness', () => {
    ...
    const result = calculateModifier(baseDamage, attacker, defender, waterMove, context);
  ...
  it('should apply Reflect modifier for physical moves (0.5x)', () => {
    ...
    const result = calculateModifier(baseDamage, attacker, defender, move, reflectContext);
  ...
  it('should not apply Reflect on critical hit', () => {
    ...
    expect(resultWithCrit.minDamage).toBeGreaterThan(resultWithoutCrit.minDamage);
  });
  ...
  it('should apply Multiscale for full HP defender (0.5x)', () => {
    ...
    const result = calculateModifier(baseDamage, attacker, defenderWithMS, move, context);
  ...
  it('should not apply Multiscale when not at full HP', () => {
    ...
    const resultWithoutMS = calculateModifier(baseDamage, attacker, defender, move, context);
