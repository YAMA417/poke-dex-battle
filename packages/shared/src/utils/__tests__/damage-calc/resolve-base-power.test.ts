...
describe('resolveBasePower', () => {
  ...
  it('should apply Helping Hand modifier (1.5x)', () => {
    ...
    const result = resolveBasePower(move, kairoyu, gabriasu, contextWithHelpingHand);
    // floor(60 * 1.5) = 90
  ...
  it('should chain multiple modifiers (Technician + Helping Hand)', () => {
    ...
    const result = resolveBasePower(move, technician, gabriasu, contextWithHelpingHand);
    expect(result).toBe(90);
  });
});
