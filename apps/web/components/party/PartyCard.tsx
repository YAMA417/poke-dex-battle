            ...
            <div className="p-4">
                ...
                <div className="flex items-start justify-between gap-2 mb-3">
                    <div className="min-w-0">
                        <Link href={`/parties/${party.id}`} className="font-bold text-gray-800 hover:text-pokemon-blue transition-colors truncate block">
                            {party.name}
                        </Link>
                    ...
                    <div className="relative shrink-0">
                        ...
                        {menuOpen && (
                            <>
                                ...
                                <div className="absolute right-0 top-full mt-1 z-20 bg-white border border-gray-100 rounded-xl shadow-xl overflow-hidden min-w-[140px]">
                                    <Link
                                    ...
                                    <button
                                        onClick={() => { onDuplicate(party.id); setMenuOpen(false); }}
                ...
                <div className="grid grid-cols-6 gap-1 mb-3">
                    {Array.from({ length: 6 }).map((_, i) => {
                        ...
                        return (
                            <div key={i} className="aspect-square bg-gray-50 rounded-xl flex items-center justify-center overflow-hidden border border-gray-100">
                                {pk?.speciesId ? (
                ...
                {/* メモ (任意) */}
                {party.memo && (
                    <p className="mt-2 text-[11px] text-gray-500 line-clamp-1 bg-gray-50 px-2 py-1 rounded-lg">
                        {party.memo}
                    </p>
                )}
            </div>
